...
class CueLabelSlider(QtWidgets.QWidget):
    ...
    def __init__(self, label=None, parent=None, default_value=0, min_value=0, max_value=999):
    ...
    def setupConnections(self):
        """Sets up widget signals."""
        # pylint: disable=no-member
        self.valueChanged.connect(self._changeLabelValue)
    ...
    def _changeLabelValue(self, value):
